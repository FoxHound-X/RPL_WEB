        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="admin/kelas_edit.php?id=<?= $row['nama_kelas'] ?>" class="btn-edit"><i class="fas fa-edit"></i></a>
                        <a href="admin/kelas_hapus.php?id=<?= $row['nama_kelas'] ?>" 
                           class="btn-delete" 
                           onclick="return confirm('Yakin ingin menghapus kelas ini?')"><i class="fas fa-trash"></i></a>
                    </td>
                </tr>
        <?php } 
        } else { ?>
